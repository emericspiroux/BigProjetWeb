...
<div><h2><span class='glyphicon glyphicon-stats'></span>&nbsp;Correction of <?if (isset($name_student)){ echo $name_student;}?> for <?if (isset($name_activity)){ echo str_replace('_', ' ', $name_activity);}?></h2></div><br>
<div style='position:relative;bottom:2em;border:1px solid black; width:100%;'></div>
<img src="<?php echo base_url().$img_student?>" class="img-circle" style="position:absolute;width:10em;height:10em;border:2px solid grey;left:80%;">
